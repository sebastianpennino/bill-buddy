...
/* Constant Keys
-----------------------------------------------*/
export interface IConstantKey {
  type: 'constant';
  label: string;
  id: 'E' | 'PI';
}
export const e: IConstantKey = { type: 'constant', label: 'e', id: 'E' } as const;
export const pi: IConstantKey = { type: 'constant', label: '&Pi;', id: 'PI' } as const;
